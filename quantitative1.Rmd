...
Another change from the "obvious" is that we should divide this by n-1 instead of n, and with this we have the famous formula for the `r hl()$fontcolor("Variance")`:
